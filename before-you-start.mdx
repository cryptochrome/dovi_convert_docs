...
<Callout icon="circle-info" color="#1e66f5" iconType="solid">
...
<Callout icon="lightbulb" color="#40a02b" iconType="solid">
...
<Callout icon="circle-exclamation" color="#fe640b" iconType="solid">
